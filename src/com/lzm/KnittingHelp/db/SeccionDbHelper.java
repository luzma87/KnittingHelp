...
public class SeccionDbHelper extends DbHelper {
    ...
    public static final String[] KEYS_SECCION = {KEY_PATTERN_ID, KEY_CONTENIDO, KEY_IMAGEN, KEY_ORDEN, KEY_SECCION_PADRE_ID};
    ...
    public Seccion get(long id) {
        SQLiteDatabase db = this.getWritableDatabase();
        String selectQuery = "SELECT s." + ALIAS_SECCION + "_" + KEY_ID + ", " +
